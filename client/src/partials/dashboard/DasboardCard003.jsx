  ...
  return (
    <div className="flex flex-col bg-[#FFFFFF] dark:bg-[rgba(37,33,57,1)] shadow-md p-6 w-full sm:w-56 border border-[#FFFFFF] dark:border-[#FFFFFF]">
      ...
      <div className="flex flex-col mb-4">
        <p className="text-lg text-gray-700 mb-3 font-light dark:text-gray-200">Rank</p>
        <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-200">Newbie</h2>
      </div>
