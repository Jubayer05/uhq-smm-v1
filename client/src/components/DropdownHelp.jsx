...
function DropdownHelp({
  ...
  return (
    <div className="relative inline-flex">
      <button
        ref={trigger}
        className={`w-8 h-8 flex items-center justify-center hover:bg-gray-100 lg:hover:bg-gray-200 dark:bg-[var(--color-dark-gray)]  border-gray-200 dark:border-gray-700 rounded-full ${dropdownOpen && 'bg-gray-200 dark:bg-blue-950'}`}
        aria-haspopup="true"
