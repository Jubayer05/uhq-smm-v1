      ...
      <Popover>
        <PopoverTrigger asChild>
          <button
            id="date"
            className={cn(
              "btn px-2.5 min-w-[15.5rem] bg-white border-gray-200 hover:border-gray-300 dark:border-gray-700/60 dark:bg-[#7C23FE] text-gray-600 hover:text-gray-800 dark:text-white font-medium text-left justify-start rounded-full", // Removed dark:hover:text-[#7C23FE]
